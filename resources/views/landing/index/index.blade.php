...
@section('content')
    ...
    <div class="fake" id='top'>
        <div class="w100 siteTop animated" id='siteTop'>
            <div class="container">
                <a class="pull"><img src="/zipper/img/menu.jpg" alt=""></a>
                <ul>
                ...
                <div class="logo">
                    <img src='/zipper/img/logo.gif' alt='<?=$language['logo_title']; ?>'>
                </div>
                <div class="right">
                    <div class="langs">
                    ...
                    <div class="phones">
                        <div class='flex'>
                            <img src="/zipper/img/phone-icon.png" alt="">
                            <div class="flex fdc">
    ...
    <div class="service w100 pad" id='service'>
        ...
        <!--<h3 class="title_def"><?/*=$language['service']; */?></h3>-->
            <div class="flex owl-carousel owl-service animated">
                <div class="i">
                    <div class="item">
                        <div class="image"><img src="/zipper/img/icons/11.png" alt=""></div>
                        <p><?=$language['s1']; ?></p>
                    </div>
                </div>
                <div class="i">
                    <div class="item">
                        <div class="image"><img src="/zipper/img/icons/12.png" alt=""></div>
                        <p><?=$language['s2']; ?></p>
                    </div>
                </div>
                <div class="i">
                    <div class="item">
                        <div class="image"><img src="/zipper/img/icons/13.png" alt=""></div>
                        <p><?=$language['s3']; ?></p>
                    </div>
                </div>
                <div class="i">
                    <div class="item">
                        <div class="image"><img src="/zipper/img/icons/14.png" alt=""></div>
                        <p><?=$language['s4']; ?></p>
                    </div>
                </div>
            </div>
    ...
    <div class="service w100 pad" id='service'>
        ...
        <!--<h3 class="title_def"><?/*=$language['service']; */?></h3>-->
            <div class="flex owl-carousel owl-service2 animated">
                <div class="i">
                    <div class="item">
                        <div class="image"><img src="/zipper/img/icons/21.png" alt=""></div>
                        <p><?=$language['s5']; ?></p>
                    </div>
                </div>
                <div class="i">
                    <div class="item">
                        <div class="image"><img src="/zipper/img/icons/22.png" alt=""></div>
                        <p><?=$language['s6']; ?></p>
                    </div>
                </div>
                <div class="i">
                    <div class="item">
                        <div class="image"><img src="/zipper/img/icons/23.png" alt=""></div>
                        <p><?=$language['s7']; ?></p>
                    </div>
                </div>
            </div>
    ...
    <div class="service w100 pad" id='service'>
        ...
        <!--<h3 class="title_def"><?/*=$language['service']; */?></h3>-->
            <div class="flex owl-carousel owl-service animated">
                <div class="i">
                    <div class="item">
                        <div class="image"><img src="/zipper/img/i5.png" alt=""></div>
                        <p><?=$language['s9']; ?></p>
                    </div>
                </div>
                <div class="i">
    ...
    <div class="steps pad w100" id="steps">
        <div class="container">
            ...
            <img class='back' src='/zipper/img/line-back.png' alt=''>
            <div class="flex">
                <div class="item i1">
                    <div class="top">1</div>
                    <p><?=$language['step1']; ?></p>
    ...
    <div class="partners w100 grad pad">
        <div class="container">
            ...
            <div class="owl-carousel owl-partners animated">
                <div class="item"><img src="/zipper/img/p5.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p6.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p7.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p8.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p1.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p2.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p3.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p4.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p9.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p10.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p11.png" alt=""></div>
                <div class="item"><img src="/zipper/img/p12.png" alt=""></div>
            </div>
    ...
    <div class="w100 pad reviews" id='reviews'>
        <div class="container">
            ...
            <div class="owl-carousel owl-reviews">
                <a href="/zipper/img/reviewsRU/3.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/3.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/1.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/1.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/4.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/4.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/6.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/6.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/2.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/2.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/7.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/7.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/8.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/8.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/5.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/5.jpg" alt=""></a>
            </div>
            <?php } else { ?>
            <div class="owl-carousel owl-reviews">
                <a href="/zipper/img/reviewsENG/1.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/1.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/1.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/1.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/4.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/4.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/6.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/6.jpg" alt=""></a>
                <a href="/zipper/img/reviewsRU/2.jpg" data-fancybox="reviews"><img src="/zipper/img/reviewsRU/thumbs/2.jpg" alt=""></a>
    ...
    <div class="questions pad grad">
        <div class="container">
            ...
            <form action="/zipper/action.php" method="post">
                ...
                <div class="loading">
                    <img src="/zipper/css/fancybox_loading.gif" alt="Загрузка">
                </div>
            </form>
        </div>
    </div>
